...
<div class="col-sm-10">
<input type="text" class="form-control" id="Pr_nombre" name="Pr_nombre" placeholder="ingrese el primer nombre">
</div>
</div>
<div class="form-group">
 <label for="Segundo Nombre" class="col-sm-2 control-label">Segundo Nombre:</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="Sg_nombre" name="Sg_nombre" placeholder="ingrese el segundo nombre"> 
</div>
</div> 
<div class="form-group">
          <label for="Apellido Paterno" class="col-sm-2 control-label">Apellido Paterno:</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="Ap_Paterno" name="Ap_paterno" placeholder="ingrese el Apellido paterno">
</div>
</div>
<div class="form-group">
          <label for="Apellido Materno" class="col-sm-2 control-label">Apellido Materno:</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="Ap_Materno" name="Ap_materno" placeholder="ingrese el Apellido materno">
</div>
</div>
<div class="form-group">
...
<div class="col-sm-10">
<input type="text" class="form-control" id="Telefono" name="Telefono" placeholder="ingrese el numero Telefonico">
</div>
</div>
<div class="form-group">
 <label for="Celular" class="col-sm-2 control-label">Celular:</label>
<div class="col-sm-10">
<input type="text"class="form-control" id="Celular" name="Celular" placeholder="ingrese el numero Celular">
</div>
</div>
<div class="form-group">
