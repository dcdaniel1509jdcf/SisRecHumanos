...
$db = new dbObj();
 ...
 $result = mysqli_query($connString,"Select rp.Id_rol, t.Pr_nombre, rp.Basico_unificado,rp.H_extras ,rp.Decimos,rp.Bonos,rp.Otro_ingresos,rp.Fondos_reserva,rp.Devoluciones,rp.Aportes_iess,rp.Impuestos_renta,
rp.Prestamo_hipotecario,rp.Prestamo_Quirografarios,rp.Prestamo_Empresa,rp.Multas,rp.Seguro_medico,rp.Anticipos,rp.Otros_descuentos,rp.Total_ingreso,rp.Total_deducciones,rp.Neto_recibir  FROM rol_pagos rp
INNER JOIN trabajadores t
ON rp.id_Trabajadores = t.id_Trabajadores  where Id_trabajadores=$trabajadores ") or die("database error:". mysqli_error($connString));
